          ...
          <form onSubmit={handleSubmit} className="space-y-6 mb-12 text-left">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <select
                  defaultValue="+234"
                  className="shrink-0 px-3 py-4 rounded-xl bg-white/10 border border-white/20 text-white/70 text-sm focus:outline-none focus:border-yellow-500/50 focus:bg-white/15 transition-all duration-200 appearance-none"
            ...
            <button
              type="submit"
              className="w-full py-4 rounded-xl bg-white text-black font-semibold text-sm tracking-[0.1em] uppercase hover:bg-white/90 transition-all duration-200"
            >
              Send Message
            </button>
          </form>
