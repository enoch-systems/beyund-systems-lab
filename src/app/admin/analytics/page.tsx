...
export default function AnalyticsPage() {
  return (
    <div className="flex flex-col items-center justify-center py-24 px-4">
      <div className="w-16 h-16 rounded-[18px] bg-[#f2f2f7] dark:bg-[#181818] flex items-center justify-center mb-5">
      ...
      <div className="mt-5 inline-flex items-center gap-2 px-3 py-1.5 rounded-[6px] bg-[#f2f2f7] dark:bg-[#181818] text-[11px] font-medium text-[#86868b] dark:text-[#98989d]">
