...
type AnnouncementType = "system" | "academic" | "admin";
type Priority = "low" | "medium" | "high" | "urgent";

const announcements: { id: number; title: string; message: string; type: AnnouncementType; priority: Priority; date: string; read: boolean }[] = [
