  ...
  return (
    <div className="w-full space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        {/* ── Admin Profile Card ── */}
        <div className="rounded-[12px] border border-[#e5e5ea] dark:border-[#38383a] bg-white dark:bg-[#1c1c1e] p-5 lg:row-span-2">
          <div className="mb-4">
            <h2 className="text-[13px] font-semibold text-[#1d1d1f] dark:text-white">
              Admin Profile
            </h2>
            ...
            >
              {profileImage ? (
                <img
                  src={profileImage}
                  alt="Profile"
                  className="w-14 h-14 rounded-full object-cover border-2 border-[#e5e5ea] dark:border-[#38383a]"
                />
              ) : (
                <div className="w-14 h-14 rounded-full bg-[#f2f2f7] dark:bg-[#2c2c2e] border-2 border-[#e5e5ea] dark:border-[#38383a] flex items-center justify-center overflow-hidden">
                  <Camera className="w-5 h-5 text-[#86868b] dark:text-[#98989d]" />
                </div>
              )}
              <div className="absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full bg-[#1d1d1f] dark:bg-white flex items-center justify-center border-2 border-white dark:border-[#1c1c1e] shadow-sm">
                <Pencil className="w-2.5 h-2.5 text-white dark:text-[#1d1d1f]" />
              </div>
            </div>
            <div>
              <p className="text-[11px] font-medium text-[#1d1d1f] dark:text-white">
                Profile Photo
              </p>
              <p className="text-[10px] text-[#86868b] dark:text-[#98989d] mt-0.5">
          ...
          <div className="space-y-3">
            {/* Name */}
            <div>
              <label className="block text-[11px] font-medium text-[#1d1d1f] dark:text-white mb-1">
                Name
              </label>
              <input
                type="text"
                ...
                className="w-full h-[36px] px-3 rounded-[8px] bg-[#f2f2f7] dark:bg-[#2c2c2e] border border-[#e5e5ea] dark:border-[#38383a] text-[12px] text-[#1d1d1f] dark:text-white placeholder-[#86868b] focus:outline-none focus:ring-2 focus:ring-[#8940fa]/25 focus:border-[#8940fa]/40 transition-all"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#86868b] pointer-events-none" />
                <input
                  type="email"
                  value={adminEmail}
                  disabled
                  className="w-full h-[36px] pl-9 pr-3 rounded-[8px] bg-[#f2f2f7] dark:bg-[#2c2c2e] border border-[#e5e5ea] dark:border-[#38383a] text-[12px] text-[#86868b] dark:text-[#98989d] cursor-not-allowed"
                />
              </div>
              <p className="text-[10px] text-[#86868b] dark:text-[#98989d] mt-1">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="inline-flex items-center gap-1.5 h-[34px] px-4 rounded-[8px] bg-[#1d1d1f] dark:bg-white text-white dark:text-[#1d1d1f] text-[11px] font-semibold hover:bg-[#2d2d2f] dark:hover:bg-[#f0f0f0] transition-all disabled:opacity-50 active:scale-[0.98] cursor-pointer"
            >
              {saving ? (
                <>
        ...
        {/* ── Password Card ── */}
        <div className="rounded-[12px] border border-[#e5e5ea] dark:border-[#38383a] bg-white dark:bg-[#1c1c1e] p-5">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-[10px] bg-[#f2f2f7] dark:bg-[#2c2c2e] flex items-center justify-center">
              <Lock className="w-4 h-4 text-[#86868b] dark:text-[#98989d]" />
            </div>
            <div>
              <h2 className="text-[13px] font-semibold text-[#1d1d1f] dark:text-white">
                Password
          ...
          <p className="text-[11px] text-[#86868b] dark:text-[#98989d] mb-3">
            A password reset link will be sent to your email address.
          </p>
          <button
            onClick={() => setShowResetModal(true)}
            className="inline-flex items-center gap-1.5 h-[32px] px-3.5 rounded-[8px] border border-[#e5e5ea] dark:border-[#38383a] text-[11px] font-medium text-[#1d1d1f] dark:text-white hover:bg-[#f2f2f7] dark:hover:bg-[#2c2c2e] transition-all cursor-pointer"
          >
        ...
        <div className="rounded-[12px] border border-[#e5e5ea] dark:border-[#38383a] bg-white dark:bg-[#1c1c1e] p-5">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-[10px] bg-[#f2f2f7] dark:bg-[#2c2c2e] flex items-center justify-center">
              <Palette className="w-4 h-4 text-[#ff9f0a]" />
            </div>
            <div>
              <h2 className="text-[13px] font-semibold text-[#1d1d1f] dark:text-white">
                Appearance
          ...
          <div className="flex items-center justify-between p-3 rounded-[10px] bg-[#f2f2f7] dark:bg-[#2c2c2e]">
            <div className="flex items-center gap-3">
              {theme === "dark" ? (
                <Moon className="w-4 h-4 text-[#98989d]" />
              ) : (
        ...
        {/* ── Account Card ── */}
        <div className="rounded-[12px] border border-[#e5e5ea] dark:border-[#38383a] bg-white dark:bg-[#1c1c1e] p-5 lg:col-span-1">
          <div className="mb-3">
            <h2 className="text-[13px] font-semibold text-[#1d1d1f] dark:text-white">
              Account
            </h2>
          ...
          <div className="p-3 rounded-[10px] bg-[#f2f2f7] dark:bg-[#2c2c2e]">
            <p className="text-[11px] text-[#86868b] dark:text-[#98989d] mb-2.5">
              Sign out from your admin account. You will need to sign in again.
            </p>
            <button
              onClick={() => setShowSignOutModal(true)}
              className="inline-flex items-center gap-1.5 h-[32px] px-3.5 rounded-[8px] border border-[#ff453a]/20 text-[11px] font-medium text-[#ff453a] hover:bg-[#ff453a]/8 transition-all cursor-pointer"
            >
