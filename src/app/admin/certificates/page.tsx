  ...
  if (students.length === 0) {
    return (
      <div className="space-y-5">
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center rounded-2xl border border-dashed border-[#e2e8f0] dark:border-[#1a1a1a] bg-white dark:bg-[#121212]">
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {filtered.map((c) => (
          <div
            key={c.student.id}
            className="rounded-[12px] border border-[#e2e8f0] dark:border-[#1a1a1a] bg-white dark:bg-[#121212] p-4"
          >
            ...
            {c.issued && (
              <div className="flex items-center gap-4 text-[10px] text-neutral-400 dark:text-neutral-600 mt-2 pt-2.5 border-t border-[#e2e8f0] dark:border-[#1a1a1a]">
                <span>
