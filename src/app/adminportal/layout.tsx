  ...
  return (
    <header style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, flex: 1, minWidth: 0 }}>
          ...
          <Link href="/adminportal" className="lg:hidden">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <Link href="/adminportal/notifications" style={{ position: "relative", background: "transparent", border: "none", cursor: "pointer", padding: 4, color: C.muted, display: "flex", textDecoration: "none" }}>
            <Bell size={13} />
            {unreadCount > 0 ? (
              <span style={{
          ...
          <Link href="/adminportal/settings" style={{
